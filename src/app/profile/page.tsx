...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen text-white" style={{ backgroundColor: '#131720' }}>
      {/* Header Section */}
      <section>
      ...
      <div className="container mx-auto px-64 py-8">
        <div className="  rounded-t-lg p-3 shadow-lg" style={{ backgroundColor: '#151f30' }}>
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-0.5xl font-bold text-white mb-0">John Doe</h3>
                <span className="text-0.5xl text-gray-200 text-sm">FlixTV ID: 11104</span>
              </div>
            </div>
          ...
          {activeTab === 'profile' && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
                <div className="rounded-2xl p-4" style={{ backgroundColor: '#151f30' }}>
                  <h3 className="text-xl font-semibold mb-4 flex items-center">
                    ...
                    <span className="text-white">Movies for you</span>
                  </h3>
