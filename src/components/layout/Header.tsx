              ...
              <ul className="header__nav">
                ...
                <li className="header__nav-item">
                  ...
                  >
                    ...
                    <li>
                      <Link href="/category">Category style 1</Link>
                    </li>
                    <li>
                      <Link href="/category2">Category style 2</Link>
                    </li>
                    <li>
                      <Link href="/details">Details style 1</Link>
                    </li>
                    <li>
                      <Link href="/details2">Details style 2</Link>
                    </li>
                    <li>
                      <Link href="/details3">Details style 3</Link>
                    </li>
                  </ul>
                </li>
                ...
                {/* Pricing */}
                <li className="header__nav-item">
                  <Link className="header__nav-link" href="/pricing">
                    Pricing plans
                  </Link>
                </li>
