...
export default function Sidebar({ activePage }: SidebarProps) {
  ...
  // Dashboard active
  const isDataboardActive = pathname === "/databoard" || pathname === "/databoard/";
  ...
  return (
    <div className="sidebar">
      {/* Logo */}
      <Link href="/databoard" className="sidebar__logo">
      ...
      <ul className="sidebar__nav">
        ...
        <li className="sidebar__nav-item">
          <Link
            href="/databoard"
            className={`sidebar__nav-link ${isDataboardActive ? "sidebar__nav-link--active" : ""}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li className="sidebar__nav-item">
          <Link
            href="/catalog"
            className={`sidebar__nav-link ${pathname?.startsWith("/catalog") ? "sidebar__nav-link--active" : ""}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li className="sidebar__nav-item">
          <a
            className={`sidebar__nav-link ${isPagesOpen ? "sidebar__nav-link--active" : ""}`}
            onClick={(e) => {
              e.preventDefault();
          ...
          >
            {[
              { key: "add-item", href: "/pages/add-item", label: "Add item" },
              { key: "edit-user", href: "/pages/edit-user", label: "Edit user" },
              { key: "signin", href: "/pages/signin", label: "Sign in" },
              { key: "signup", href: "/pages/signup", label: "Sign up" },
              { key: "forgot", href: "/pages/forgot", label: "Forgot password" },
              { key: "404", href: "/pages/404", label: "404 page" },
            ].map((item) => (
              <li key={item.key}>
                <Link
                  href={item.href}
                  ...
                  style={{
                    display: "block",
                    padding: "8px 0",
                    color: activePage === item.key ? "#fff" : "#a1a1b2",
                    fontSize: "14px",
        ...
        <li className="sidebar__nav-item">
          <Link href="/users" className={`sidebar__nav-link ${pathname?.startsWith("/users") ? "sidebar__nav-link--active" : ""}`}>
        ...
        <li className="sidebar__nav-item">
          <Link href="/comments" className={`sidebar__nav-link ${pathname?.startsWith("/comments") ? "sidebar__nav-link--active" : ""}`}>
        ...
        <li className="sidebar__nav-item">
          <Link href="/reviews" className={`sidebar__nav-link ${pathname?.startsWith("/reviews") ? "sidebar__nav-link--active" : ""}`}>
      ...
      <div className="sidebar__copyright">
        ...
        Create by <a href="https://themeforest.net/user/dmitryvolkov" target="_blank" rel="noreferrer">Dmitry Volkov</a>
      </div>
    </div>
  );
}