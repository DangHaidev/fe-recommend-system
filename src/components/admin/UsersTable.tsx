        ...
        <tbody>
          {usersData.map((user) => (
            ...
            <tr key={user.id} className="main__table-tr">
              ...
              <td>
                <div className="main__user">
                  <div className="main__avatar">
                    <img src="/img/user.svg" alt={user.name} />
                  </div>
              ...
              <td><div className="main__table-text">{user.username}</div></td>
              <td><div className="main__table-text">{user.plan}</div></td>
              <td><div className="main__table-text">{user.comments}</div></td>
              <td><div className="main__table-text">{user.reviews}</div></td>
              <td>
                <div className={`main__table-text ${user.status === "Banned" ? "main__table-text--red" : "main__table-text--green"}`}>
                  {user.status}
                </div>
              </td>
              <td><div className="main__table-text">{user.date}</div></td>
              <td>
