      ...
      <table className="main__table">
        ...
        <tbody>
          {catalogData.map((item) => (
            <tr key={item.id}>
              <td><div className="main__table-text">{item.id}</div></td>
              <td><div className="main__table-text"><a href="#">{item.title}</a></div></td>
              <td>
              ...
              <td><div className="main__table-text">{item.category}</div></td>
              <td><div className="main__table-text">{item.views}</div></td>
              <td>
                <div className={`main__table-text ${item.status === "Visible" ? "main__table-text--green" : "main__table-text--red"}`}>
                  {item.status}
                </div>
              </td>
              <td><div className="main__table-text">{item.date}</div></td>
              <td>
