...
const SearchBar = () => {
    ...
    const data: { id: number; title: string; genre: string; year: number }[] = [
        {
            id: 1,
    ...
    return (
        <>
            <form action="#" className="header__form relative">
                <input
                ...
                {results.length > 0 && (
                    <ul className="absolute bg-blue-950 text-white top-20 w-full">
