...
export function Footer() {
  return (
    // filepath: d:\Project1\DOAN\fe-recommend-system\src\components\auth\Footer.tsx
      ...
      <div className="container">
        <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-6">
                <div className="footer__nav">
                  ...
                  <Link href="/live">Live News</Link>
                  <Link href="/live">Live Sports</Link>
                  <Link href="/live">Streaming Library</Link>
                </div>
              </div>
              <div className="col-6">
                <div className="footer__nav">
                  <Link href="/category">TV Shows</Link>
                  <Link href="/category">Movies</Link>
                  <Link href="/category">Kids</Link>
          ...
          <div className="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
            ...
            <div className="footer__nav">
              <Link href="/privacy">Account & Billing</Link>
              <Link href="/privacy">Plans & Pricing</Link>
              <Link href="/privacy">Supported devices</Link>
