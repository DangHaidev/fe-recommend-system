...
export default function Hero() {
  ...
  return (
    <section className="section section--head section--head-fixed section--gradient section--details-bg" style={{ marginTop: '-20px' }}>
      <div className="section__bg" style={{ backgroundImage: "url(/img/details.jpg)" }}></div>
          ...
          <div className="row">
            <div className="col-12 col-xl-8">
              ...
              {showTrailer && (
                ...
                >
                  <div
                    style={{ position: "relative", width: "80vw", maxWidth: 900, height: "60vw", maxHeight: 500, background: "black" }}
            ...
            <div className="col-12 col-xl-8">
              ...
              <div className="categories">
                ...
                <a href="category.html" className="categories__item">
                  Action
                </a>
                <a href="category.html" className="categories__item">
                  Thriller
